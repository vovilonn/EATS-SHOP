...
const ProfileNavigation: FC = () => {
  ...
  const navigationLinks = [
    ...
    { name: 'Про нас', icon: AboutIcon, href: '/about' },
    { name: 'Налаштування', icon: SettingsIcon, href: '/profile/personal-info', },
    { name: 'Правова інформація', icon: AboutIcon, href: '/privacy' },
